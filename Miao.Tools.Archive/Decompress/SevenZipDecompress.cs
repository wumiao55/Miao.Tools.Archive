...
namespace Miao.Tools.Archive.Decompress
{
    ...
    /// 7z解压缩
    /// </summary>
    public class SevenZipDecompress : IDecompress
    {
        /// <summary>
        /// 构造方法
        /// </summary>
        /// <param name="sevenZFile"></param>
        public SevenZipDecompress(string sevenZFile)
        {
            CompressFile = sevenZFile;
            IsSupport = string.Equals(SupportExtension, Path.GetExtension(sevenZFile), StringComparison.OrdinalIgnoreCase);
        }
        ...
        /// 支持的压缩文件扩展名
        /// </summary>
        public string SupportExtension { get; } = ".7z";
